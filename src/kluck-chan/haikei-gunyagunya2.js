/*
 * original: http://hitode909.github.io/hatenablog-unofficial-modules/haikei-gunyagunya2.js
 */

/*

* はてなブログの背景を記事内の画像にしてぐにゃぐにゃさせる(2)
...
(function() {
 ...
 // https://github.com/josephg/noisejs public domain
  /*
  ...
  module.perlin3 = function(x, y, z) {
    ...
    $(function() {
        ...
        var check = function() {
            ...
            if (!src) return false;
            $('html').find(':visible:first').css('background', 'url(' + src + ')');
            return true;
        };
